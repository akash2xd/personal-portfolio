...
function ContactSection() {
  return (
    <div id="contact" className="relative z-50 py-24 lg:py-48 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-indigo-500/10 blur-[80px] rounded-full pointer-events-none" />
          ...
          <div className="flex flex-col items-center gap-6 mb-20">
            <div className="flex items-center gap-3 text-indigo-400">
              <div className="w-10 h-10 rounded-xl bg-indigo-500/10 flex items-center justify-center">
                <MessageSquare className="w-5 h-5 shadow-[0_0_10px_rgba(99,102,241,0.5)]" />
              </div>
