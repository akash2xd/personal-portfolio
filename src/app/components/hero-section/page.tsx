...
import { FaTwitterSquare, FaStackOverflow } from "react-icons/fa";
...
const HeroSection = () => {
  ...
  useGSAP(
    () => {
      ...
      gsap.to(".social-icon", {
        ...
        stagger: 0.2,
        ease: "sine.inOut",
        force3D: true, // Forces hardware acceleration for these perpetually moving elements
      });

      // Cleanup timeline on unmount if it's still running
      return () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-indigo-600/10 blur-[80px] rounded-full" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-cyan-900/10 blur-[80px] rounded-full" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center px-4 md:px-8 relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start gap-8">
          <div className="flex flex-col gap-4">
            <span className="hero-tag px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-bold tracking-[0.3em] w-fit">
            ...
            <h1 className="hero-heading text-5xl md:text-6xl lg:text-7xl font-black text-white leading-[1.1]">
              ...
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-cyan-900">
                Masterpieces
              </span>
            </h1>
            <p className="hero-heading text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
              ...
              a professional
              <span
                className="text-indigo-400 ml-2 font-bold inline-block min-w-[200px]"
                ref={designationRef}
              >
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              <Link
                ...
                className="social-icon p-3 rounded-xl bg-white/5 border border-white/10 text-white hover:text-cyan-400 hover:border-cyan-400/50 transition-all duration-300 shadow-xl"
              >
                <BsGithub size={24} />
              </Link>
              <Link
            ...
            <div className="hero-cta flex flex-wrap gap-4">
              <Link
                href="/#contact"
                className="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-indigo-600 to-cyan-800 text-white font-bold uppercase tracking-wider overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(99,102,241,0.3)]"
              >
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group px-8 py-4 rounded-2xl border border-white/10 bg-white/5 text-white font-bold uppercase tracking-wider transition-all hover:bg-white/10 hover:border-indigo-500/50 flex items-center gap-2"
              >
                Get Resume{" "}
        ...
        <div className="order-1 lg:order-2 flex justify-center">
          ...
          >
            <div
              ref={codeCardRef}
              className="relative rounded-3xl border border-white/10 bg-[#171717] overflow-hidden shadow-2xl group"
            >
              {/* Card Header */}
                ...
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-cyan-300">'Aragha Gupta'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-cyan-300">'Web Development & AI/ML with Python'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-cyan-400">"Build with Purpose"</span>
                    </p>
                  </div>
                  <div className="flex gap-4">
